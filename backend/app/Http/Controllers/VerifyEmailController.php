...
class VerifyEmailController extends Controller
{
    ...
    public function __invoke(Request $request): RedirectResponse
    {
        ...
        /* if ($user->hasVerifiedEmail()) {
            return redirect()->intended(config('premium.dashboard') . '?verified=1');
        } */
        ...
        return redirect()->route('login')->with('status', $message); //if user is already logged in it will redirect to the dashboard page
    }
}